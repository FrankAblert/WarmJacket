...
public class CookExpandableListViewAdapter extends BaseExpandableListAdapter {
    ...
    private int[] mImgs = {R.mipmap.classify_layout_tablerow_changjianshicai
        ,R.mipmap.classify_layout_tablerow_fangshi, R.mipmap.classify_layout_tablerow_zhongguocaixi
        ,R.mipmap.classify_layout_tablerow_renqun, R.mipmap.classify_layout_tablerow_chuju};
